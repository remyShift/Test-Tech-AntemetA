'use strict';
/* build-hook-start *//*00001*/try { require('/Users/remy_mac/.cursor/extensions/wallabyjs.console-ninja-1.0.445/out/buildHook/index.js').default({tool: 'jest', checkSum: '20f07b47096799e9e1500bVAkZVRoHCgoEUwtaUF0BUlZTVFQD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/remy_mac/.cursor/extensions/wallabyjs.console-ninja-1.0.445/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20f07b47096799e9e1500bVAkZVRoHCgoEUwtaUF0BUlZTVFQD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
